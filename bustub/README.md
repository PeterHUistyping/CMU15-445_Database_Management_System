...
$ docker create -t -i --privileged=true --name bustub -v "$(pwd):/bustub" bustub bash
docker run -i -t --privileged=true --name=bustub -v "$(pwd):/bustub" bustub bash
```
...
setenforce 0 --privileged=true


docker container run -it -v "/Users/peterhu/Documents/Learning/CS/IA/M Databases 12h/CMU15-445 645 Database Systems 19Fall/Project":/bustub --name=bustub_env bustub /bin/bash

docker container run -it -v "/Users/peterhu/Documents/Learning/CS/IA/M Databases 12h/CMU15-445 645 Database Systems 19Fall/Project":/bustub --privileged=true --name=bustub_env bustub  /bin/bash
